...
export default interface IProductsUserRepository {
    ...
    findByProductId(product_id: string, user_id: string): Promise<ProductUser | undefined>;
    findUsersByProduct(product_id: string, relations: string[]): Promise<ProductUser[]>
