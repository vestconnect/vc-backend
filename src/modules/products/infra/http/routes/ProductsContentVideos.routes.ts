...
productContentVideoRouter.patch('/:id/background', ensureAuthenticated, upload.single('background'), productContentVideoBackgroundController.update);
productContentVideoRouter.patch('/:id/file', ensureAuthenticated, upload.single('file'), productContentVideoFileController.update);
