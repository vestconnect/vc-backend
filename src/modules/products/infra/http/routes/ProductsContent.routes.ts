...
productsContentRouter.get(
  "/:id/:type",
  ensureAuthenticated,
  productsContentController.index
);
productsContentRouter.post(
  "/",
  ensureAuthenticated,
  productsContentController.create
);
productsContentRouter.patch(
  "/:id/background",
  ensureAuthenticated,
  upload.single("background"),
  productContentBackgroundController.update
);
productsContentRouter.delete(
  "/:id",
  ensureAuthenticated,
  productsContentController.delete
);
